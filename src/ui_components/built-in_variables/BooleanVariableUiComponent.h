#ifndef _BOOLEAN_VARIABLE_UI_COMPONENT_H_
#define _BOOLEAN_VARIABLE_UI_COMPONENT_H_
...
class BooleanVariableUiComponent: public VariableUiComponent {
    private:
        /* VARIBALES */
        UiType::TYPE type;
        std::string value;
    ...
    protected:
        BooleanVariableUiComponent(UiType::TYPE type, std::string value);
...
#endif // _BOOLEAN_VARIABLE_UI_COMPONENT_H_